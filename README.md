...
* Faz uma página exclusiva com informação máxima que encontrares sobre REST API e Integração com Java (front-end | back-end). 
Podes colocar exemplos práticos de uso como fizemos no exemplo em cima (part II).
